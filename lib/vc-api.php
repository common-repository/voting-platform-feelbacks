...
if(!class_exists('VicomiAPI')) {
    ...
    class VicomiAPI {
        ...
        function __construct() {
            ...
            $this->api_url = 'https://dashboard.vicomi.com/';
            $this->api_url_new = 'https://api-secondary.vicomi.com/';
        }
        ...
        function register_source($name, $host) {
            ...
            $response = $this->call('api/v1/widget/reg/wordpress', $params, true, true);
            return $response;
        ...
        function call($method, $args=array(), $post=false,$new=false) {
            if($new) {
                $url = $this->api_url_new . $method . '/';
            } else {
